...
import (
	...
	"github.com/mkazutaka/courtney/tester/logger"
	"github.com/mkazutaka/courtney/tester/merge"
...
func (t *Tester) processDir(dir string) error {
	...
	if err != nil {
		// TODO: Remove when https://github.com/mkazutaka/courtney/issues/4 is fixed
		// notest
		if t.setup.Verbose {
